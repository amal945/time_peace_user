...
class WorkWearProductsScreen extends StatefulWidget {
  const WorkWearProductsScreen({Key? key}) : super(key: key);

  @override
  State<WorkWearProductsScreen> createState() => _WorkWearProductsScreenState();
}

class _WorkWearProductsScreenState extends State<WorkWearProductsScreen> {
            ...
            children: [
              ...
              StreamBuilder(
                stream: FirebaseFirestore.instance
                    .collection('products')
                    .where('productType', isEqualTo: "Workwear")
                    .snapshots(),
